...
protected void onServiceConnected() {
    ...
    private void createFloatingButton() {
        ...
        try {
            ...
            Log.d(
                    "SnapFloatDebug",
                    "MAIN_WHITE_BUTTON_CREATED"
            );

        } catch (Exception e) {
            Log.e(
                    "SnapFloatDebug",
                    "MAIN_WHITE_BUTTON_CREATE_ERROR",
                    e
            );
            floatingButton = null;
            return;
        ...
        // دکمه وضعیت خوب: ابتدا آبی
        try {
            goodButton = new Button(this);
            goodButton.setText("");
            goodButton.setPadding(0, 0, 0, 0);
            setButtonBackground(goodButton, Color.BLUE);
            ...
            Log.e(
                    "SnapFloatDebug",
                    "GOOD_BUTTON_CREATE_ERROR",
                    e
            );
            goodButton = null;
        }

        // دکمه وضعیت بد: ابتدا مشکی
        try {
            badButton = new Button(this);
            badButton.setText("");
            badButton.setPadding(0, 0, 0, 0);
            setButtonBackground(badButton, Color.BLACK);
...
private void setButtonColor(int color) {
    ...
    setButtonBackground(floatingButton, color);
}

private void setGoodButtonColor(int color) {
    setButtonBackground(goodButton, color);
}

private void setBadButtonColor(int color) {
    setButtonBackground(badButton, color);
}
